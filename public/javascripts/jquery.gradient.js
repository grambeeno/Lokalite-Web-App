...
// this works
//
  //$this.prepend('<div style="display:' + $this.css("display") + '; position: relative; z-index: 2;">');
  //$this.append('</div>');
  //$this.prepend(html.join(''));

// this does not : scripts are executed twice
//
  //$this.wrapInner('<div style="display:' + $this.css("display") + '; position: relative; z-index: 2;" />');
  //$this.wrapInner('<div id=42 />');
  //$this.prepend(html.join(''));
