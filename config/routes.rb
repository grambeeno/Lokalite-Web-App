...
Lokalite::Application.routes.draw do |map|
  ...
  match 'events/categories', :as => :event_categories, :controller => :events, :action => :categories, :format => :mobile :constraints => { :subdomain => /boulderweekly/ } 
  ...
  devise_scope :user do
    match '/business' => 'devise/registrations#new', :business => true, :as => 'business_sign_up'
  end
  ...
  match 'approve_events' => 'my/events#approve', :as => :approve_events
